...
class DisplayLogs(Screen):
    def __init__(self, **kwargs):
        ...
        self.hostname_value=Label(text='tmp')
        ...
        self.app_component_value = Label(text='tmp')
        ...
        self.time_value = Label(text='tmp')
    ...
    def process_file(self, selected_file):
        try:
            ...
            for i, log in enumerate(log_list):
                button = Button(text=log[:60], size_hint_y=None, height=40, background_color=(0.2, 0.6, 1, 1), color=(1, 1, 1, 1))
